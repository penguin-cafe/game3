...
(lib.error_mc = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(160,150.0012,1,1.0004);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	mask.setTransform(150,145.0119);
...
lib.properties = {
	...
	manifest: [
		...
		{src:"./images/payer_error.png", id:"payer_error"},
