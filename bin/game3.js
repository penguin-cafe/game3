...
(lib.payer_error = function() {
	this.initialize(img.payer_error);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,40,40);
...
(lib.player_error_mc = function(mode,startPosition,loop) {
	...
	// img
	this.instance = new lib.payer_error();
	this.instance.parent = this;
	this.instance.setTransform(-20,-20);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.player_error_mc, new cjs.Rectangle(-20,-20,40,40), null);
...
}).prototype = getMCSymbolPrototype(lib.player_art_mc, new cjs.Rectangle(-20,-20,40,40), null);
...
(lib.error_mc = function(mode,startPosition,loop) {
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF9900").s().dr(-160,-149.95,320,299.9);
	this.shape.setTransform(160,150);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.error_mc, new cjs.Rectangle(0,0,320,300), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#DEDEDE").s().dr(-160,-149.95,320,299.9);
	this.shape.setTransform(160,150);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.area_mc, new cjs.Rectangle(0,0,320,300), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.player_error_mc.cache(-22,-22,44,44);
	...
	this.player_art_mc.cache(-22,-22,44,44);
...
}).prototype = getMCSymbolPrototype(lib.player_mc, new cjs.Rectangle(-20,-20,40,40), null);
...
(lib.life_mc = function(mode,startPosition,loop) {
	...
	// life_num_mc
	this.life_3_mc = new lib.player_art_mc();
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.hit_mc.name = "hit_mc";
	this.hit_mc.parent = this;
	this.hit_mc.setTransform(0,0,2,2);
	this.hit_mc.alpha = 0.012;
	this.hit_mc.cache(-22,-22,44,44);

	this.timeline.addTween(cjs.Tween.get(this.hit_mc).wait(1));

}).prototype = getMCSymbolPrototype(lib.L_R_btn, new cjs.Rectangle(-40,-40,80,80), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		var count_max_num = 7;
		//速度
		var speed_num = root.in_time_num;
		//速度係数
		var speed_k_num = 1;
		//速度制限
		var speed_limit_num = 100;
		//衝突判定する対象
		...
		this.reset_func = function() {
			...
			count_num = 0;
			//速度調節
			speed_num = root.in_time_limit_array[ root.active_obj.level ] - ( root.active_obj.score * speed_k_num );
		...
		this.in_func = function() {
			...
			if ( root.active_obj.life > 0 ) {
				...
				timer_id = setInterval( function() {
					...
					count_num += 1;
					//移動位置算出
					var move_num = ini_y_num + ( 40 * count_num );
					//効果音
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	mask._off = true;
	mask.graphics.p("A0T1FMArvAAAMAAAArvMgrvAAAg");
	mask.setTransform(150,145);

	// error_num_mc
	this.error_7_mc = new lib.enemy_error_mc();
	this.error_7_mc.name = "error_7_mc";
	this.error_7_mc.parent = this;
	this.error_7_mc.setTransform(280.2,269.9,1,1,0,0,0,0.2,-0.1);
	this.error_7_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 0, 0, 0)];
	this.error_7_mc.cache(-22,-22,44,44);

	this.error_6_mc = new lib.enemy_error_mc();
	this.error_6_mc.name = "error_6_mc";
	this.error_6_mc.parent = this;
	this.error_6_mc.setTransform(240.2,269.9,1,1,0,0,0,0.2,-0.1);
	this.error_6_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 0, 0, 0)];
	this.error_6_mc.cache(-22,-22,44,44);

	this.error_5_mc = new lib.enemy_error_mc();
	this.error_5_mc.name = "error_5_mc";
	this.error_5_mc.parent = this;
	this.error_5_mc.setTransform(200.2,269.9,1,1,0,0,0,0.2,-0.1);
	this.error_5_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 0, 0, 0)];
	this.error_5_mc.cache(-22,-22,44,44);

	this.error_4_mc = new lib.enemy_error_mc();
	this.error_4_mc.name = "error_4_mc";
	this.error_4_mc.parent = this;
	this.error_4_mc.setTransform(160.2,269.9,1,1,0,0,0,0.2,-0.1);
	this.error_4_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 0, 0, 0)];
	...
	this.error_3_mc.setTransform(120.2,269.9,1,1,0,0,0,0.2,-0.1);
	this.error_3_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 0, 0, 0)];
	...
	this.error_2_mc.setTransform(80.2,269.9,1,1,0,0,0,0.2,-0.1);
	this.error_2_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 0, 0, 0)];
	...
	this.error_1_mc.setTransform(40.2,269.9,1,1,0,0,0,0.2,-0.1);
	this.error_1_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 0, 0, 0)];
	this.error_1_mc.cache(-22,-22,44,44);

	var maskedShapeInstanceList = [this.error_7_mc,this.error_6_mc,this.error_5_mc,this.error_4_mc,this.error_3_mc,this.error_2_mc,this.error_1_mc];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.error_1_mc},{t:this.error_2_mc},{t:this.error_3_mc},{t:this.error_4_mc},{t:this.error_5_mc},{t:this.error_6_mc},{t:this.error_7_mc}]}).wait(1));

	// hit_num_mc
	this.hit_7_mc = new lib.hit_num_mc();
	this.hit_7_mc.name = "hit_7_mc";
	this.hit_7_mc.parent = this;
	this.hit_7_mc.setTransform(280.1,-9.8,1,1,0,0,0,0.1,0.2);

	this.hit_6_mc = new lib.hit_num_mc();
	this.hit_6_mc.name = "hit_6_mc";
	this.hit_6_mc.parent = this;
	this.hit_6_mc.setTransform(240.1,-9.8,1,1,0,0,0,0.1,0.2);

	this.hit_5_mc = new lib.hit_num_mc();
	this.hit_5_mc.name = "hit_5_mc";
	this.hit_5_mc.parent = this;
	this.hit_5_mc.setTransform(200.1,-9.8,1,1,0,0,0,0.1,0.2);

	this.hit_4_mc = new lib.hit_num_mc();
	this.hit_4_mc.name = "hit_4_mc";
	this.hit_4_mc.parent = this;
	this.hit_4_mc.setTransform(160.1,-9.8,1,1,0,0,0,0.1,0.2);

	this.hit_3_mc = new lib.hit_num_mc();
	this.hit_3_mc.name = "hit_3_mc";
	this.hit_3_mc.parent = this;
	this.hit_3_mc.setTransform(120.1,-9.8,1,1,0,0,0,0.1,0.2);

	this.hit_2_mc = new lib.hit_num_mc();
	this.hit_2_mc.name = "hit_2_mc";
	this.hit_2_mc.parent = this;
	this.hit_2_mc.setTransform(80.1,-9.8,1,1,0,0,0,0.1,0.2);

	this.hit_1_mc = new lib.hit_num_mc();
	this.hit_1_mc.name = "hit_1_mc";
	this.hit_1_mc.parent = this;
	this.hit_1_mc.setTransform(40.1,-9.8,1,1,0,0,0,0.1,0.2);

	var maskedShapeInstanceList = [this.hit_7_mc,this.hit_6_mc,this.hit_5_mc,this.hit_4_mc,this.hit_3_mc,this.hit_2_mc,this.hit_1_mc];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.hit_1_mc},{t:this.hit_2_mc},{t:this.hit_3_mc},{t:this.hit_4_mc},{t:this.hit_5_mc},{t:this.hit_6_mc},{t:this.hit_7_mc}]}).wait(1));

	// pos_num_num_mc
	this.pos_7_6_mc = new lib.enemy_art_mc();
	this.pos_7_6_mc.name = "pos_7_6_mc";
	this.pos_7_6_mc.parent = this;
	this.pos_7_6_mc.setTransform(280.1,230.2,1,1,0,0,0,0.1,0.2);
	this.pos_7_6_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_7_6_mc.cache(-22,-22,44,44);

	this.pos_7_5_mc = new lib.enemy_art_mc();
	this.pos_7_5_mc.name = "pos_7_5_mc";
	this.pos_7_5_mc.parent = this;
	this.pos_7_5_mc.setTransform(280.1,190.2,1,1,0,0,0,0.1,0.2);
	this.pos_7_5_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_7_5_mc.cache(-22,-22,44,44);

	this.pos_7_4_mc = new lib.enemy_art_mc();
	this.pos_7_4_mc.name = "pos_7_4_mc";
	this.pos_7_4_mc.parent = this;
	this.pos_7_4_mc.setTransform(280.1,150.2,1,1,0,0,0,0.1,0.2);
	this.pos_7_4_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_7_4_mc.cache(-22,-22,44,44);

	this.pos_7_3_mc = new lib.enemy_art_mc();
	this.pos_7_3_mc.name = "pos_7_3_mc";
	this.pos_7_3_mc.parent = this;
	this.pos_7_3_mc.setTransform(280.1,110.2,1,1,0,0,0,0.1,0.2);
	this.pos_7_3_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_7_3_mc.cache(-22,-22,44,44);

	this.pos_7_2_mc = new lib.enemy_art_mc();
	this.pos_7_2_mc.name = "pos_7_2_mc";
	this.pos_7_2_mc.parent = this;
	this.pos_7_2_mc.setTransform(280.1,70.2,1,1,0,0,0,0.1,0.2);
	this.pos_7_2_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_7_2_mc.cache(-22,-22,44,44);

	this.pos_7_1_mc = new lib.enemy_art_mc();
	this.pos_7_1_mc.name = "pos_7_1_mc";
	this.pos_7_1_mc.parent = this;
	this.pos_7_1_mc.setTransform(280.1,30.2,1,1,0,0,0,0.1,0.2);
	this.pos_7_1_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_7_1_mc.cache(-22,-22,44,44);

	this.pos_6_6_mc = new lib.enemy_art_mc();
	this.pos_6_6_mc.name = "pos_6_6_mc";
	this.pos_6_6_mc.parent = this;
	this.pos_6_6_mc.setTransform(240.1,230.2,1,1,0,0,0,0.1,0.2);
	this.pos_6_6_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_6_6_mc.cache(-22,-22,44,44);

	this.pos_6_5_mc = new lib.enemy_art_mc();
	this.pos_6_5_mc.name = "pos_6_5_mc";
	this.pos_6_5_mc.parent = this;
	this.pos_6_5_mc.setTransform(240.1,190.2,1,1,0,0,0,0.1,0.2);
	this.pos_6_5_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_6_5_mc.cache(-22,-22,44,44);

	this.pos_6_4_mc = new lib.enemy_art_mc();
	this.pos_6_4_mc.name = "pos_6_4_mc";
	this.pos_6_4_mc.parent = this;
	this.pos_6_4_mc.setTransform(240.1,150.2,1,1,0,0,0,0.1,0.2);
	this.pos_6_4_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_6_4_mc.cache(-22,-22,44,44);

	this.pos_6_3_mc = new lib.enemy_art_mc();
	this.pos_6_3_mc.name = "pos_6_3_mc";
	this.pos_6_3_mc.parent = this;
	this.pos_6_3_mc.setTransform(240.1,110.2,1,1,0,0,0,0.1,0.2);
	this.pos_6_3_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_6_3_mc.cache(-22,-22,44,44);

	this.pos_6_2_mc = new lib.enemy_art_mc();
	this.pos_6_2_mc.name = "pos_6_2_mc";
	this.pos_6_2_mc.parent = this;
	this.pos_6_2_mc.setTransform(240.1,70.2,1,1,0,0,0,0.1,0.2);
	this.pos_6_2_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_6_2_mc.cache(-22,-22,44,44);

	this.pos_6_1_mc = new lib.enemy_art_mc();
	this.pos_6_1_mc.name = "pos_6_1_mc";
	this.pos_6_1_mc.parent = this;
	this.pos_6_1_mc.setTransform(240.1,30.2,1,1,0,0,0,0.1,0.2);
	this.pos_6_1_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_6_1_mc.cache(-22,-22,44,44);

	this.pos_5_6_mc = new lib.enemy_art_mc();
	this.pos_5_6_mc.name = "pos_5_6_mc";
	this.pos_5_6_mc.parent = this;
	this.pos_5_6_mc.setTransform(200.1,230.2,1,1,0,0,0,0.1,0.2);
	this.pos_5_6_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_5_6_mc.cache(-22,-22,44,44);

	this.pos_5_5_mc = new lib.enemy_art_mc();
	this.pos_5_5_mc.name = "pos_5_5_mc";
	this.pos_5_5_mc.parent = this;
	this.pos_5_5_mc.setTransform(200.1,190.2,1,1,0,0,0,0.1,0.2);
	this.pos_5_5_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_5_5_mc.cache(-22,-22,44,44);

	this.pos_5_4_mc = new lib.enemy_art_mc();
	this.pos_5_4_mc.name = "pos_5_4_mc";
	this.pos_5_4_mc.parent = this;
	this.pos_5_4_mc.setTransform(200.1,150.2,1,1,0,0,0,0.1,0.2);
	this.pos_5_4_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_5_4_mc.cache(-22,-22,44,44);

	this.pos_5_3_mc = new lib.enemy_art_mc();
	this.pos_5_3_mc.name = "pos_5_3_mc";
	this.pos_5_3_mc.parent = this;
	this.pos_5_3_mc.setTransform(200.1,110.2,1,1,0,0,0,0.1,0.2);
	this.pos_5_3_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_5_3_mc.cache(-22,-22,44,44);

	this.pos_5_2_mc = new lib.enemy_art_mc();
	this.pos_5_2_mc.name = "pos_5_2_mc";
	this.pos_5_2_mc.parent = this;
	this.pos_5_2_mc.setTransform(200.1,70.2,1,1,0,0,0,0.1,0.2);
	this.pos_5_2_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_5_2_mc.cache(-22,-22,44,44);

	this.pos_5_1_mc = new lib.enemy_art_mc();
	this.pos_5_1_mc.name = "pos_5_1_mc";
	this.pos_5_1_mc.parent = this;
	this.pos_5_1_mc.setTransform(200.1,30.2,1,1,0,0,0,0.1,0.2);
	this.pos_5_1_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.pos_5_1_mc.cache(-22,-22,44,44);

	this.pos_4_6_mc = new lib.enemy_art_mc();
	this.pos_4_6_mc.name = "pos_4_6_mc";
	this.pos_4_6_mc.parent = this;
	this.pos_4_6_mc.setTransform(160.1,230.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_4_5_mc.setTransform(160.1,190.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_4_4_mc.setTransform(160.1,150.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_4_3_mc.setTransform(160.1,110.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_4_2_mc.setTransform(160.1,70.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_4_1_mc.setTransform(160.1,30.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_3_6_mc.setTransform(120.1,230.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_3_5_mc.setTransform(120.1,190.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_3_4_mc.setTransform(120.1,150.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_3_3_mc.setTransform(120.1,110.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_3_2_mc.setTransform(120.1,70.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_3_1_mc.setTransform(120.1,30.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_2_6_mc.setTransform(80.1,230.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_2_5_mc.setTransform(80.1,190.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_2_4_mc.setTransform(80.1,150.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_2_3_mc.setTransform(80.1,110.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_2_2_mc.setTransform(80.1,70.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_2_1_mc.setTransform(80.1,30.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_1_6_mc.setTransform(40.1,230.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_1_5_mc.setTransform(40.1,190.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_1_4_mc.setTransform(40.1,150.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_1_3_mc.setTransform(40.1,110.2,1,1,0,0,0,0.1,0.2);
	...
	this.pos_1_2_mc.setTransform(40.1,70.2,1,1,0,0,0,0.1,0.2);
	...
	// move_num_mc
	this.move_7_mc = new lib.player_art_mc();
	this.move_7_mc.name = "move_7_mc";
	this.move_7_mc.parent = this;
	this.move_7_mc.setTransform(280,270);
	this.move_7_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.move_7_mc.cache(-22,-22,44,44);

	this.move_6_mc = new lib.player_art_mc();
	this.move_6_mc.name = "move_6_mc";
	this.move_6_mc.parent = this;
	this.move_6_mc.setTransform(240,270);
	this.move_6_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.move_6_mc.cache(-22,-22,44,44);

	this.move_5_mc = new lib.player_art_mc();
	this.move_5_mc.name = "move_5_mc";
	this.move_5_mc.parent = this;
	this.move_5_mc.setTransform(200,270);
	this.move_5_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.move_5_mc.cache(-22,-22,44,44);

	this.move_4_mc = new lib.player_art_mc();
	this.move_4_mc.name = "move_4_mc";
	this.move_4_mc.parent = this;
	this.move_4_mc.setTransform(160,270);
	this.move_4_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.move_4_mc.cache(-22,-22,44,44);

	this.move_3_mc = new lib.player_art_mc();
	this.move_3_mc.name = "move_3_mc";
	this.move_3_mc.parent = this;
	this.move_3_mc.setTransform(120,270);
	this.move_3_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.move_3_mc.cache(-22,-22,44,44);

	this.move_2_mc = new lib.player_art_mc();
	this.move_2_mc.name = "move_2_mc";
	this.move_2_mc.parent = this;
	this.move_2_mc.setTransform(80,270);
	this.move_2_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.move_2_mc.cache(-22,-22,44,44);

	this.move_1_mc = new lib.player_art_mc();
	this.move_1_mc.name = "move_1_mc";
	this.move_1_mc.parent = this;
	this.move_1_mc.setTransform(40,270);
	this.move_1_mc.filters = [new cjs.ColorFilter(0, 0, 0, 1, 204, 204, 204, 0)];
	this.move_1_mc.cache(-22,-22,44,44);

	var maskedShapeInstanceList = [this.move_7_mc,this.move_6_mc,this.move_5_mc,this.move_4_mc,this.move_3_mc,this.move_2_mc,this.move_1_mc];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.move_1_mc},{t:this.move_2_mc},{t:this.move_3_mc},{t:this.move_4_mc},{t:this.move_5_mc},{t:this.move_6_mc},{t:this.move_7_mc}]}).wait(1));

	// error_mc
	this.error_mc = new lib.error_mc();
	this.error_mc.name = "error_mc";
	this.error_mc.parent = this;
	this.error_mc.cache(-2,-2,324,304);
	...
	this.area_mc.cache(-2,-2,324,304);

	this.timeline.addTween(cjs.Tween.get(this.area_mc).wait(1));

}).prototype = getMCSymbolPrototype(lib.game_mc, new cjs.Rectangle(0,0,320,300), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.R_btn.setTransform(270,40,1,1,90);
	this.R_btn.cache(-42,-42,84,84);

	this.L_btn = new lib.L_R_btn();
	this.L_btn.name = "L_btn";
	this.L_btn.parent = this;
	this.L_btn.setTransform(40,40,1,1,-90);
	this.L_btn.cache(-42,-42,84,84);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.L_btn},{t:this.R_btn}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.control_mc, new cjs.Rectangle(0,0,310,80), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		//速度
		this.in_time_num = 0;
		this.in_time_array = [ 0, 400, 300, 200 ];
		//制限
		this.in_time_limit_array = [ 0, 200, 150, 100 ];
	...
	this.life_mc.setTransform(90,375);
	...
	this.control_mc.setTransform(5,365);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"./images/enemy_art.png?1527156971425", id:"enemy_art"},
		{src:"./images/enemy_error.png?1527156971425", id:"enemy_error"},
		{src:"./images/payer_error.png?1527156971425", id:"payer_error"},
		{src:"./images/player_art.png?1527156971425", id:"player_art"},
		{src:"./images/spacer.png?1527156971425", id:"spacer"},
		{src:"./sounds/gamestart.mp3?1527156971425", id:"gamestart"},
		{src:"./sounds/level.mp3?1527156971425", id:"level"}
	],
	preloads: []
};
